...
export default function WhifffLogo() {
  return (
    <div className="text-center pt-6 pb-0 px-5 animate-fadeUp relative">
      ...
      <div className="absolute top-[70px] left-1/2 -ml-[105px]">
      ...
      <h1 className="font-shrikhand text-[clamp(56px,14vw,80px)] text-[#D4191A] m-0 leading-none tracking-tight" style={{ WebkitTextStroke: "1px black", textShadow: "0 4px 20px rgba(0,0,0,0.15)" }}>
        whifff
      </h1>
      <p className="font-playfair text-[clamp(14px,3.5vw,18px)] text-white mt-1.5 opacity-85 [text-shadow:0_2px_10px_rgba(0,40,80,0.1)]">
